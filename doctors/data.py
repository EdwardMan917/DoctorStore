...
def create_test_data():
    ...
    Category(query_name="category_a", name="cat_a", doctor=doctor_test_a).save()
    Category(query_name="category_b", name="cat_b", doctor=doctor_test_a).save()
    Category(query_name="category_c", name="cat_c", doctor=doctor_test_a).save()
    Category(query_name="category_b", name="cat_b", doctor=doctor_test_b).save()
    ...
    Service(item="service_a", price=100, remarks=None, doctor=doctor_test_a).save()
    Service(item="service_b", price=500, remarks=None, doctor=doctor_test_a).save()
    Service(item="service_c", price=250, remarks=None, doctor=doctor_test_b).save()
